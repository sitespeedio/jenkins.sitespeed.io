...
public class ParameterHelper {
	...
	public List<String> getSitespeedParameters(String configuration,
			String resultBaseDir) {
		LinkedList<String> argList = getArgsAsList(configuration);
		removeUnwantedParameters(argList, SITESPEED_PARAMETERS_TO_REMOVE,
				logStream);
		argList.add("-r");
	...
	public List<String> getJUnitParamters(String configuration,
			String outputDir, String resultBaseDir) {
		LinkedList<String> argList = getArgsAsList(configuration);
		removeUnwantedParameters(argList, SITESPEED_JUNIT_PARAMETERS_TO_REMOVE,
				logStream);
		argList.add("-o");
	...
	private void removeUnwantedParameters(LinkedList<String> args,
			Set<String> argsToRemove, PrintStream logStream) {
